...
class VGGBase(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1x1_sf_vis = nn.Conv2d(256,256,kernel_size=1, padding=0, stride=1, bias=True)
        self.conv1x1_sf_vis.weight.data.normal_(0, 0.01)
        self.conv1x1_sf_vis.bias.data.fill_(0.01)
    ...
    def load_pretrained_layers(self):
        ...
        for i, param in enumerate(param_names[49:98]):    
        ...
        for i, param in enumerate(param_names[98:-22]):    
...
class Sejong_PD(nn.Module):
    ...
    def forward(self, image_vis, image_lwir):
        ...
        conv4_3_feats, conv6_feats , conv7_feats= self.base(image_vis, image_lwir) 
